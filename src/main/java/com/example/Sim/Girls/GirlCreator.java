...
public class GirlCreator {
    ...
    public Girl createGirl(String girlFile) throws GirlCreationException{
        ...
        try {
            ...
            GirlCreationException girlCreationException = new GirlCreationException();
            girlCreationException.setTextMessage("Error creating girl from file : "+path+"\n\nError : " + e.getClass().toString() +"."+ e.getMessage());
            throw girlCreationException;
        }
    }
    public Girl createRandomGirl(String girlFile) throws GirlCreationException{
        Girl girl = new Girl();
        String path = directory + girlFile;
        try {
            Document doc = openDocument(path);
            ...
            for (int i = 1; i < skillList.getLength(); i++) {
                ...
                girl.addSkill(new Skill(nodename, nodeValueMinInt, nodeValueMaxInt));
